...
swagger_template = {
    ...
    "info": {
        "title": "Libros API",
        "description": "Servicio de autenticación y catálogo de libros con JWT y Redis.",
        "version": "1.0.0"
    },
    "securityDefinitions": {
        "Bearer": {
...
def health():
    ...
    responses:
      ...
      500:
        description: Falló algún componente
    """
    db_ok = False
    redis_ok = False
...
def refresh():
    ...
    responses:
      ...
      400:
        description: No se envió refresh_token
      401:
...
def redis_status():
    ...
    responses:
      200:
        description: Información de Redis
      403:
